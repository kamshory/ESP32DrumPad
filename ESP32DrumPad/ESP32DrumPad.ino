...
int	offsetWSScheme	=	133	; //	5	String	Scheme WS
int	offsetWSHost	=	138	; //	40	String	Host WS
int	offsetWSPort	=	178	; //	2	Word	Port WS
int	offsetWSPath	=	180	; //	50	String	Path WS
int	offsetWSUsername	=	230	; //	20	String	Username WS
int	offsetWSPassword	=	250	; //	20	String	Password WS
int	offsetEnable	=	270	; //	1	Byte	Enable WS
int	offsetConfigured	=	271	; //	1	Byte	Flag that controller was configured
int	offsetSolo	=	272	; //	1	Byte	Flag solo channel
int	offsetSoloChannel	=	273	; //	1	Byte	Solo channel number
int	offsetMCUser	=	274	; //	20	String	MIDI Controller username
int	offsetMCPassword	=	294	; //	20	String	MIDI Controller password
int	midiChannel	=	314	; //	1	Byte	MIDI channel
int	readInterval	=	315	; //	4	DWord	Read analog interval
int	offsetCh1	=	319	; //	10	String	Channel 1
int	offsetCh2	=	329	; //	10	String	Channel 2
int	offsetCh3	=	339	; //	10	String	Channel 3
int	offsetCh4	=	349	; //	10	String	Channel 4
int	offsetCh5	=	359	; //	10	String	Channel 5
int	offsetCh6	=	369	; //	10	String	Channel 6
int	offsetCh7	=	379	; //	10	String	Channel 7
int	offsetCh8	=	389	; //	10	String	Channel 8
int	offsetCh9	=	399	; //	10	String	Channel 9
int	offsetCh10	=	409	; //	10	String	Channel 10
int	offsetCh11	=	419	; //	10	String	Channel 11
int	offsetCh12	=	429	; //	10	String	Channel 12
int	offsetCh13	=	439	; //	10	String	Channel 13
int	offsetCh14	=	449	; //	10	String	Channel 14
int	offsetCh15	=	459	; //	10	String	Channel 15
int	offsetCh16	=	469	; //	10	String	Channel 16
